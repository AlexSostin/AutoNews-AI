...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='article',
            field=models.OneToOneField(help_text='Article this specification belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='vehicle_specs', to='news.article'),
        ),
