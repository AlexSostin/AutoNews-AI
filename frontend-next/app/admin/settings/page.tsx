        ...
        <div className={`rounded-lg shadow-md p-6 border-2 ${formData.maintenance_mode ? 'bg-orange-50 border-orange-400' : 'bg-white border-transparent'}`}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Close site for updates</p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-gray-900">
                    {formData.maintenance_mode ? '🚧 Maintenance Mode ON' : 'Maintenance Mode OFF'}
                  </p>
                  <p className="text-sm text-gray-500">
                    {formData.maintenance_mode
                      ? 'Visitors see "Under Maintenance". You (Admin) see the full site.'
                      : 'Site is visible to all visitors'}
                  </p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
            ...
            {formData.maintenance_mode && (
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="We are improving our website. Please check back soon!"
