...
export default function AdminDashboard() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-black text-gray-950 mb-8">Dashboard</h1>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-black text-gray-950 mt-2">{stat.value}</p>
                </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-black text-gray-950 mb-4">Quick Actions</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            href="/admin/articles"
            className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-4 rounded-lg text-center font-bold hover:from-indigo-700 hover:to-purple-700 transition-all shadow-md"
          >
            Create New Article
          </Link>
          <Link
            href="/admin/categories"
            className="bg-gradient-to-r from-green-500 to-teal-500 text-white p-4 rounded-lg text-center font-bold hover:from-green-600 hover:to-teal-600 transition-all shadow-md"
          >
            Manage Categories
          </Link>
          <Link
            href="/admin/comments"
            className="bg-gradient-to-r from-orange-500 to-red-500 text-white p-4 rounded-lg text-center font-bold hover:from-orange-600 hover:to-red-600 transition-all shadow-md"
          >
            Moderate Comments
          </Link>
        </div>
      ...
      <div className="bg-white rounded-lg shadow p-6 mt-6">
        <h2 className="text-xl font-black text-gray-950 mb-4">Welcome to AutoNews Admin!</h2>
