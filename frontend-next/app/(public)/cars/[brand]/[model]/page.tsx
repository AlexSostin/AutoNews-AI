                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        {(data.vehicle_specs_list?.length > 0 || data.vehicle_specs) && (() => {
                            ...
                            const perfRows: SpecDef[] = [
                                ...
                                { label: '0-100 km/h', key: 'acceleration_0_100', format: v => v.acceleration_0_100 ? `${v.acceleration_0_100}s` : '' },
                                { label: 'Top Speed', key: 'top_speed_kmh', format: v => fmtNum(v.top_speed_kmh, 'km/h') },
                            ...
                            const dimRows: SpecDef[] = [
                                ...
                                { label: 'Weight', key: 'weight_kg', format: v => fmtNum(v.weight_kg, 'kg') },
                                ...
                                { label: 'Towing', key: 'towing_capacity_kg', format: v => fmtNum(v.towing_capacity_kg, 'kg') },
                            ];
