  ...
  return (
    <>
      ...
      <button
        ...
        className={`relative w-full my-10 rounded-2xl overflow-hidden shadow-2xl bg-black group focus:outline-none focus:ring-2 focus:ring-indigo-500 block text-left ${imgError ? 'cursor-default' : 'cursor-zoom-in'}`}
