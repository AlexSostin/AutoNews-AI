...
import { Facebook, Share2, Mail, Link2, Check } from 'lucide-react';
        ...
        {shareLinks.map((link) => {
          ...
          return (
            <a
              ...
              className={`${link.bgColor} ${link.color} text-white px-5 py-3 rounded-full font-semibold flex items-center gap-2 transition-all transform hover:scale-105 hover:shadow-xl`}
            >
              <Icon size={20} />
              {link.name}
            </a>
